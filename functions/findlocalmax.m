...
function [idx, locmax, count] = findlocalmax(data, nmax, neighborsize, irowcirc, icolcirc)

%% input:
% data: input data matrix
% nmax: number of local maximums to be found
% neighborsize: [p q] vector: mute the local maximums around a larger local
%               maximum within p points on the row and q points on the
%               column
